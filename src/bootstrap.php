...
spl_autoload_register(function ($class) {
    ...
    $paths = [
        ...
        __DIR__ . '/app/entities/' . $class . '.php',    // Entities: User, Customer...
        __DIR__ . '/app/repositories/' . $class . '.php', // Repositories: UserRepository...
        __DIR__ . '/app/models/' . $class . '.php',      // Models: Base Model
        ...
        __DIR__ . '/exceptions/' . $class . '.php',      // Exceptions: ValidationException...
    ];
